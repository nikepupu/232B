...
// 	 {
// 		int r = find( allS3SelectedOri[bestRotInd,iPart] == partRotationRange ); // the index of part rotation
// 		int Fx = therex + floor(.5+allS3SelectedRow[bestRotInd][iPart]/subsampleM2/subsampleS2);
// 		int Fy = therey + floor(.5+allS3SelectedCol[bestRotInd][iPart]/subsampleM2/subsampleS2); // sub-sampled position
...
// 		double partScores = min(MAX2map[r][iPart][bestRes]);
...
// 			///////////////////////////////////////////////////
// 			double** tmp = MAX2map[r][iPart][bestRes];
...
// 			int** current_size = size(tmp);
			
// 			tmp = largerMAX2LocTrace[r][iPart][bestPartRes];
// 			int** new_size = size(tmp);
...
// 			int actualPartRotationInd = transformInd - numPartRotate*(ceil(double(transformInd)/numPartRotate)-1);
